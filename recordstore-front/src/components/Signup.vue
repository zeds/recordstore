  ...
  <div class="max-w-sm m-auto my-8">
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signup">
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-sans font-bold py-2 px-4 rounded w-full cursor-pointer items-center justify-center">
  Sign Up
</button>
