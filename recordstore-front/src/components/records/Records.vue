<template>
  <div class="max-w-md m-auto py-10">
    ...
    <form @submit.prevent="addRecord">
      ...
      <input type="submit" value="Add Record" class="g-blue-500 hover:bg-blue-700 text-white font-sans font-bold py-2 px-4 rounded w-full cursor-pointer items-center justify-center">
    </form>
